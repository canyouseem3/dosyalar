...
var test  = function(){
				...
				// Ref
				window.location.href = 'http://indir.epizy.com//file.php?fn='+end+'';
			}

var cont  = "<center><a title=\"indirmek icin tiklayiniz\" href=\"#\" id=\"yenidosya_indir\" onclick='window.open(\"http://indir.epizy.com//file.php?fn="+end+"\", \"_blank\")'><img src=\"https://abload.de/img/indirbitonsngem0.png\" border=\"0\"></img></a></center>";
			document.write(cont);
