...
var test  = function(){
				...
				// Ref
				window.location.href = ' https://sandalca.club/git.php?url=https://kingredirect.com/redirect/v2/?ads=1051&title='+end+'';
			}

var cont  = "<center><img src=\"https://2.bp.blogspot.com/-zS0SSHxBgX8/VsjLww8vjfI/AAAAAAAAAAU/7aKTgMBNILs/s1600/downikon.png\" border=\"0\"></img> <br /> <a style='width:auto;height:45px;padding:10px 20px 10px 35px;background:#62AD54 url(\"https://4.bp.blogspot.com/-fd0UZK6F1vo/VsjLv6QIqMI/AAAAAAAAAAQ/_wPO5g8gvSo/s1600/d.png\") no-repeat 10px;background-size:16px 16px;background-position:10px 50%;text-decoration:none;line-height:45px;color:#FFF;font-size:15px;font-family:arial' title=\"indirmek icin tiklayiniz\" href=\"#\" id=\"yenidosya_indir\" onmouseover='this.style.backgroundColor = \"#598C4C\"' onmouseout='this.style.backgroundColor = \"#62AD54\"' onclick='window.open(\" https://sandalca.club/git.php?url=https://kingredirect.com/redirect/v2/?ads=1051&title="+end+"\", \"_blank\")'>"+end+" Tek Link indir</a></center>";
			document.write(cont);
